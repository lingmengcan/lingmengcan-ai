...
export const addConversation = (data: Conversation) =>
  http.request<Result<Conversation>>('chat/add-conversation', Method.POST, data);

// 更新对话
export const editConversation = (data: Conversation) =>
  http.request<Result<Conversation>>('chat/edit-conversation', Method.POST, data);
...
export const deleteMessagesByConversationId = (data: String) =>
  http.request<Result<String>>('chat/delete-messages-conversation', Method.POST, data);
